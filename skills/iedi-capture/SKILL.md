...
**Before generating Evidence, Delta, or Provider Insight:** Read `~/.claude/skills/iedi-shared/SKILL.md` with the Read tool and use the block templates, rules, and validation commands defined there.
...
All templates and validation commands are defined in `~/.claude/skills/iedi-shared/SKILL.md`. Read it first.
...
Infer from category (see `~/.claude/skills/iedi-shared/SKILL.md` work_domain rules):
...
Review the full conversation. Generate Evidence Item blocks using the template in `~/.claude/skills/iedi-shared/SKILL.md`. Skip the confirmation gate — save immediately.
...
Use the Write tool to save to the output path. Run the encoding guard (BOM check) from `~/.claude/skills/iedi-shared/SKILL.md`. Then:
...
Generate Decision blocks using the template in `~/.claude/skills/iedi-shared/SKILL.md`.
...
Generate Provider Insight using the template and 4-section structure in `~/.claude/skills/iedi-shared/SKILL.md`.
...
Run the grep validation commands from `~/.claude/skills/iedi-shared/SKILL.md`.
...
Infer work_domain from category and intent (see `~/.claude/skills/iedi-shared/SKILL.md` work_domain rules — no need to ask the user):
...
**`SOURCE_MODE=context`:** Review the full conversation. Generate Evidence Item blocks using the template in `~/.claude/skills/iedi-shared/SKILL.md`.
...
Template and rules: see `~/.claude/skills/iedi-shared/SKILL.md`. Inline fallback:
- Fields: Did, Result, Files, Outcome (all required)
- Rejected/failed items → Delta, not Evidence
- Block count: 1–5 per session
...
**`SOURCE_MODE=context`:** Review the conversation. Generate Decision blocks using the template in `~/.claude/skills/iedi-shared/SKILL.md`.
...
Template and rules: see `~/.claude/skills/iedi-shared/SKILL.md`. Inline fallback:
- Fields: Chosen, Rejected, Reason (all required)
...
**`SOURCE_MODE=context`:** Generate Provider Insight from the conversation using the template and 4-section structure in `~/.claude/skills/iedi-shared/SKILL.md`.
